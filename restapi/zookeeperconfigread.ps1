# PowerShell script for listing the files of a configset in a Zookeeper ensemble.
...
echo "Requesting listing of Zookeeper configset $NAME from $uid"
...
$RESULTS = Invoke-RestMethod -uri "https://app.searchstax.com/api/rest/v2/account/$ACCOUNT/deployment/$uid/zookeeper-config/$NAME/" -Method Get -Headers $headers
