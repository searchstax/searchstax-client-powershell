# PowerShell script for listing deployments associated with an APIkey.
...
Write-Host "Deployments associated with APIkey..." 
Write-Host $body
Write-Host

#POST https://app.searchstax.com/api/rest/v2/account/<account_name>/apikey/deployments/
$RESULT = Invoke-RestMethod -uri "https://app.searchstax.com/api/rest/v2/account/$ACCOUNT/apikey/deployments/" -Method Post -body $body -ContentType 'application/json' -Headers $headers
