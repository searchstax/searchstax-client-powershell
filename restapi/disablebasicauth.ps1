# PowerShell script for disabling Solr Basic Auth for a deployment.
...
Write-Host "Disabling Solr Basic Auth for $uid"
Write-Host
...
$RESULT = Invoke-RestMethod -uri "https://app.searchstax.com/api/rest/v2/account/$ACCOUNT/deployment/$uid/solr/auth/disable/" -Method Get -Headers $headers
