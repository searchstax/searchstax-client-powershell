...
# PowerShell script for checking the status of a restore.
...
Write-Host "Checking restore status for $SSID..."
$RESULTS = Invoke-RestMethod -Method Post -ContentType 'application/json' -Headers $headers `
              -uri "https://app.searchstax.com/api/rest/v2/account/$ACCOUNT/deployment/$SSID/restore/status/" 
