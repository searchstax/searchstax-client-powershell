...
# account > deployment > server > status
# PowerShell script for getting the status of a Solr node.
...
Write-Host "Getting status of node" $node
Write-Host
#GET api/rest/v2/account/<account_name>/deployment/<uid>/server/<node>/host-status/
