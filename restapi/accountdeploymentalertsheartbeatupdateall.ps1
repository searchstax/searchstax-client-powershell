# Script for enabling/disabling all heartbeat alerts in an account. 
...
Write-Host "Enabling/Disabling all heartbeat alerts on $uid..."
# PUT /api/rest/v2/account/{account_name}/deployment/{uid}/alerts/heartbeat/all/

$RESULTS = Invoke-RestMethod -uri "https://app.searchstax.com/api/rest/v2/account/$ACCOUNT/deployment/$uid/alerts/heartbeat/all/" -Method Put -body $body -ContentType 'application/json' -Headers $headers
