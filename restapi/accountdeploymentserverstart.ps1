...
# account > deployment > server > start
# PowerShell script for starting a Solr node.
...
Write-Host "Starting Solr node" $NODE
Write-Host
#POST api/rest/v2/account/<account_name>/deployment/<uid>/server/<node>/start-solr
