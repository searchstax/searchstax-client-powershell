# PowerShell script for listing the Solr Basic Auth users for a deployment.
...
Write-Host "Listing Solr Basic Auth users for $uid"
Write-Host
...
$RESULT = Invoke-RestMethod -uri "https://app.searchstax.com/api/rest/v2/account/$ACCOUNT/deployment/$uid/solr/auth/get-users/" -Method Get -Headers $headers
