...
# PowerShell script for listing the IP Filters of a deployment.
...
Write-Host "Listing IP Filters from" $uid
Write-Host
#GET https://app.searchstax.com/api/rest/v2/account/<account_name>/deployment/<uid>/ip-filter/?page=1
