...
Write-Host "Deleting deployment" $uid
Write-Host

$RESULT = Invoke-RestMethod -uri "https://app.searchstax.com/api/rest/v2/account/SilverQAAccount/deployment/$uid/" -Method Delete -ContentType 'application/json' -Headers $headers
