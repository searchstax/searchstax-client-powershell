...
# account > deployment > server > stop
# PowerShell script for stopping a Solr node.
...
Write-Host "Stopping Solr node" $node
Write-Host
#POST api/rest/v2/account/<account_name>/deployment/<uid>/server/<node>/stop-solr
